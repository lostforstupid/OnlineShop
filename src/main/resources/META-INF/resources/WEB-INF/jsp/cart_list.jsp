        ...
        <div class="table-responsive cart_info">
                            ...
                            <tr>
                                ...
                                <td class="cart_quantity">
                                    <div class="cart_quantity_button">
                                        <a class="cart_quantity_up" href="${pageContext.request.contextPath}/cart/${item.id}/inc"> + </a>
                                        <input class="cart_quantity_input" type="text" name="quantity"
                                               value=${item.quantity} size="2" readonly="readonly">
                                        <a href="${pageContext.request.contextPath}/cart/${item.id}/decrement" class="cart_quantity_down"> - </a>
                                    </div>
                                </td>
                                <td class="cart_total">
                                ...
                                <td class="cart_delete">
                                    <a class="cart_quantity_delete" href="${pageContext.request.contextPath}/cart/${item.id}/delete"><i
            ...
            <div class="login-form">
                <form method="GET" action="${contextPath}/cart/payment" class="form-signin">
                    ...
                    <c:choose>
                        <c:when test="${products.size() <= 0}">
                            <button class="btn btn-disabled order-button" type="submit" disabled="disabled"><spring:message code="label.cart.button.order"/></button>
                        </c:when>
                        <c:otherwise>
                            <button class="btn btn-disabled order-button" type="submit"><spring:message code="label.cart.button.order"/></button>
